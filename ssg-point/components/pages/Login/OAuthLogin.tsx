  ...
  return (
    <div className='w-full pt-[40px] pr-[40px] pb-[80px] pl-[40px] bg-[#fbfbfb]'>
      ...
      <ul className='flex justify-between'>
        <p className='naver' onClick={()=>signIn('naver', { redirect: true, callbackUrl: "/totallogin" } ) } >
        ...
        <p className='kakao' onClick={()=>signIn('kakao', { redirect: true, callbackUrl: "/totallogin" }) } >
